...
class Repeater extends Field implements ScriptField
{
    ...
    {
        return $this->getForm()->setDebugStatus(false)->setPopulate(false)->getFromFieldsString( $this->fields );
    }
